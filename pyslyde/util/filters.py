...
def tile_intensity(
    tile: np.ndarray, threshold: float, channel: Optional[int] = None
) -> Optional[bool]:
    """
...
def remove_black(
    patch: Any, threshold: int = 60, max_value: int = 255, area_thresh: float = 0.2
) -> Any:
    """
...
def remove_blue(
    ...
    upper_blue: List[int] = [130, 255, 255],
) -> Any:
    """
